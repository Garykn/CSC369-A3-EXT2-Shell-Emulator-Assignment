...
The program should work like mkdir, creating the final directory on the specified path on the disk. If any component on 
the path to the location where the final directory is to be created does not exist or if the specified directory already 
...
int main(int argc, char **argv) {
	...
	//get path of parent directory of component
	...
	//find a vacant inode for the directory we're about to create
	component_inode = find_vacantInode(); //this function also sets the inode in the inode bitmap
